...
# Specialty agents removed — only harness × role virtual agents remain.
CATALOG: list[dict[str, Any]] = [
    {
        "package_id": "pkg-claude-coder",
        "name": "Claude Coder",
        "description": "Claude Code harness × coder role",
        "publisher": "AOP Official",
        "version": "0.1.0",
        "skills": ["code-execution", "code-assist"],
        "default_endpoint": _agent_endpoint("AOP_AGENT_CLAUDE_CODER_URL", "http://127.0.0.1:8011"),
        "agent_key": "claude-coder",
        "tags": ["code", "harness", "claude"],
    },
    {
        "package_id": "pkg-claude-researcher",
        "name": "Claude Researcher",
        "description": "Claude Code harness × researcher role",
        "publisher": "AOP Official",
        "version": "0.1.0",
        "skills": ["web-research", "research-summarize", "web-search"],
        "default_endpoint": _agent_endpoint("AOP_AGENT_CLAUDE_RESEARCHER_URL", "http://127.0.0.1:8012"),
        "agent_key": "claude-researcher",
        "tags": ["research", "harness", "claude", "search"],
    },
    {
        "package_id": "pkg-pi-coder",
        "name": "Pi Coder",
        "description": "Pi harness × coder role",
        "publisher": "AOP Official",
        "version": "0.1.0",
        "skills": ["code-execution", "code-assist"],
        "default_endpoint": _agent_endpoint("AOP_AGENT_PI_CODER_URL", "http://127.0.0.1:8013"),
        "agent_key": "pi-coder",
        "tags": ["code", "harness", "pi"],
    },
    {
        "package_id": "pkg-pi-researcher",
        "name": "Pi Researcher",
        "description": "Pi harness × researcher role",
        "publisher": "AOP Official",
        "version": "0.1.0",
        "skills": ["web-research", "research-summarize", "web-search"],
        "default_endpoint": _agent_endpoint("AOP_AGENT_PI_RESEARCHER_URL", "http://127.0.0.1:8014"),
        "agent_key": "pi-researcher",
        "tags": ["research", "harness", "pi", "search"],
    },
    {
        "package_id": "pkg-deepseek-coder",
        "name": "DeepSeek Coder",
        "description": "DeepSeek Harness × coder role",
        "publisher": "AOP Official",
        "version": "0.1.0",
        "skills": ["code-execution", "code-assist"],
        "default_endpoint": _agent_endpoint("AOP_AGENT_DEEPSEEK_CODER_URL", "http://127.0.0.1:8015"),
        "agent_key": "deepseek-coder",
        "tags": ["code", "harness", "deepseek"],
    },
    {
        "package_id": "pkg-deepseek-researcher",
        "name": "DeepSeek Researcher",
        "description": "DeepSeek Harness × researcher role",
        "publisher": "AOP Official",
        "version": "0.1.0",
        "skills": ["web-research", "research-summarize", "web-search"],
        "default_endpoint": _agent_endpoint("AOP_AGENT_DEEPSEEK_RESEARCHER_URL", "http://127.0.0.1:8016"),
        "agent_key": "deepseek-researcher",
        "tags": ["research", "harness", "deepseek", "search"],
    },
]
