...
Billing 定价：`BILLING_PRICES_JSON`（可选）覆盖默认单价；返回值为**预估**，非真实扣款。详见 `docs/reference/billing.md` · `docs/reference/billing-invoice.md`。  
...
封装于 `packages/a2a-sdk`。详见 [a2a-protocol.md](../architecture/a2a-protocol.md)。
