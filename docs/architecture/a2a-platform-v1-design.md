...
| 关联文档 | [数据库设计](../reference/database.md) · [API 设计](../reference/api.md) · [Redis 设计](../reference/redis.md) · [MVP 开发计划](./mvp-plan.md) · [架构索引](./overview.md) |
...
| 文档 | 内容 |
|------|------|
| [overview.md](./overview.md) | 落地架构索引与关键路径 |
| [database.md](../reference/database.md) | PostgreSQL 表结构与 ER |
| [redis.md](../reference/redis.md) | Redis Streams / 队列 / 锁 |
| [api.md](../reference/api.md) | Gateway REST API（至 Phase 12） |
| [mvp-plan.md](./mvp-plan.md) | Phase 1–12 任务拆分与验收 |
| [agent-dev-guide.md](./agent-dev-guide.md) | Agent 开发规范 |
| [a2a-protocol.md](./a2a-protocol.md) | A2A 协议落地说明 |
